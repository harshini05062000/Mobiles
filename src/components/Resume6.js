         ...
         <div className="col-lg-3 m-2">
                <div className="card shadow">
                    <div className="card-body text-center">
                        ...
                        <br></br>
                        <h2>I PHONE 6</h2>
                        <h4 className="text-secondary">Rs.24,598</h4>
                        
                            <h5 className="text-secondary">1 GB-RAM </h5>
                            <h5 className="text-secondary">32 GB-Memory </h5>
                            <h5 className="text-secondary">Battery : 1810 mAh </h5>
                        
              
                <h6 className="text-secondary">OS : IOS 8</h6>
