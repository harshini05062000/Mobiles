...
export default function Resume4(props) {
         ...
         <div className="col-lg-3 m-2">
                <div className="card shadow">
                    <div className="card-body text-center">
                        ...
                        <br></br>
                        <h2>MI NOTE 8</h2>
                        <h4 className="text-secondary">Rs.13,499</h4>
                        
                            <h5 className="text-secondary">4 GB-RAM </h5>
                            <h5 className="text-secondary">128 GB-Memory </h5>
                            <h5 className="text-secondary">Battery : 5020 mAh  </h5>
