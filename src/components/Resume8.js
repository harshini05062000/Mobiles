         ...
         <div className="col-lg-3 m-2">
                <div className="card shadow">
                    <div className="card-body text-center">
                        ...
                        <br></br>
                        <h2>I PHONE 8</h2>
                        <h4 className="text-secondary">Rs.41,999</h4>
                        
                            <h5 className="text-secondary">2 GB-RAM </h5>
                            <h5 className="text-secondary">256 GB-Memory </h5>
                            <h5 className="text-secondary">Battery : 1821 mAh </h5>
                        
              
                <h6 className="text-secondary">OS : IOS 14.0</h6>
